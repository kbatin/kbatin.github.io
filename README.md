...
To play the game, open the Jupyter notebook [Inside Out Game Notebook](https://kbatin.github.io/Inside-Out-Game/). Follow the instructions in the notebook to play through the game.
